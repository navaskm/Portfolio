...
export const BentoGridItem = ({
  ...
  const handleCopy = ()=>{
    navigator.clipboard.writeText('navaskm228@gmail.com');
    setCopied(true);
    ...
    >
      ...
      <div className={`${id === 6 && 'flex justify-center'}h-full`}>
        ...
        <div className={cn(
          ...
          <div className="font-sans font-extralight md:max-w-32 md:text-xs text-[#c1c2d3] text-sm lg:text-base z-10">
            {
              description
            }
          </div>

          <div className="font-sans font-bold text-lg lg:text-3xl z-30">
            {title}
          </div>
